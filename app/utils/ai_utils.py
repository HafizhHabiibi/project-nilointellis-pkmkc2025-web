...
def get_ai_response(api_key, model_name, prompt, temperature=0.25, top_p=0.85, top_k=40, system_instruction=None):
    """
    ...
    contents = messages_to_contents(prompt)
...
# Convert session messages to genai Content format
